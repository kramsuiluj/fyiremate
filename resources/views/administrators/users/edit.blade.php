<x-layout>
        ...
        <x-containers.content>
            <div>
                <h2 class="font-montserrat px-5 py-5 border-b text-center">
                    <span class="font-semibold text-blue-900">EDIT END USER PROFILE</span>
                </h2>
            </div>
    ...
    <form action="{{ route('administrators.users.update', $user->id) }}" method="POST" id="create-establishment">
        @csrf
        @method('PATCH')
    </form>
