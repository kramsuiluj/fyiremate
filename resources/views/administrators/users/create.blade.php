<x-layout>
        ...
        <x-containers.content>
            <div>
                <h2 class="font-montserrat px-5 py-5 border-b text-center">
                    <span class="font-semibold text-blue-900">CREATE END USER</span>
                </h2>
            </div>
            ...
            <div class="font-montserrat mt-5 px-5 pb-5 flex gap-5">
                <div class="w-1/2">
                    ...
                    <div>
                        <label for="username" class="block mb-2 text-sm font-medium text-slate-600 dark:text-white">
                            <span>Username</span>
                        </label>
                        <div class="relative mb-6">
                            <div class="absolute inset-y-0 left-0 flex items-center pl-3 pointer-events-none">
                            ...
                            <input name="username" type="text" class="bg-gray-50 border border-gray-300 text-slate-600 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full pl-5 p-2.5  dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Username" value="{{ old('username') }}" form="create-establishment" required>
                            @error('username')
                            <p class="text-xs absolute text-red-500">{{ $message }}</p>
                            @enderror
                        </div>
                    ...
                    <div>
                        <label for="password" class="block mb-2 text-sm font-medium text-slate-600 dark:text-white">
                            <span>Password</span>
                        </label>
                        <div class="relative mb-6">
                            <div class="absolute inset-y-0 left-0 flex items-center pl-3 pointer-events-none">
                            ...
                            <input name="password" type="password" class="bg-gray-50 border border-gray-300 text-slate-600 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full pl-5 p-2.5  dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Password" value="{{ old('password') }}" form="create-establishment" required>
                            @error('password')
                            <p class="text-xs absolute text-red-500">{{ $message }}</p>
                            @enderror
                        </div>
                    ...
                    <div>
                        <label for="password_confirmation" class="block mb-2 text-sm font-medium text-slate-600 dark:text-white">
                        ...
                        <div class="relative mb-6">
                            ...
                            <input name="password_confirmation" type="password" class="bg-gray-50 border border-gray-300 text-slate-600 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full pl-5 p-2.5  dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Confirm Password" value="{{ old('password_confirmation') }}" form="create-establishment" required>
    ...
    <form action="{{ route('administrators.users.store') }}" method="POST" id="create-establishment">
        @csrf
    </form>
