            ...
            @if(count($inspectors) == 0)
                <div class="py-2 px-2 rounded pb-5">
                    <p class="font-montserrat text-sm text-slate-500 flex space-x-1 items-center justify-center underline">
                        ...
                        <span>Currently, there are no inspectors in the system.</span>
                    </p>
                </div>
            @else
                                    ...
                                    <tr class="hover:bg-gray-100">
                                        ...
                                        <td class="px-6 py-4 whitespace-nowrap">
                                            <div class="flex items-center justify-center">
                                                <div class="ml-4">
                                                    <div class="text-xs text-slate-600">
                                                        {{ date('F j, Y, g:i a', strtotime($inspector->created_at)) }}
                                                    </div>
                                                </div>
                                            </div>
                                        </td>
                                            ...
                                            <div class="flex items-center justify-center">
                                                <div class="ml-4">
                                                    <div class="text-xs text-slate-600 flex space-x-3 items-center">
                                                        <div>
                                                            <a id="edit-button" href="{{ route('administrators.inspectors.edit',
                                                    $inspector->id)
                                                        ...
                                                        <div x-data="{ show: false }">
                                                            <a id="delete-button" href="#" @click.prevent="show = !show" class="text-red-700">
                                                                ...
                                                                <form id="delete-{{ $inspector->id }}" action="{{ route
                                                        ('administrators.inspectors.destroy', $inspector->id) }}" method="POST"
                                                                      style="display: none">
                                                                    @csrf
                                                                    @method('DELETE')
                                                                </form>
