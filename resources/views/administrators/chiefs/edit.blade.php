<x-layout>
    ...
    <form action="{{ route('administrators.chiefs.update', $marshal->id) }}" method="POST" id="create-establishment">
        @csrf
        @method('PATCH')
    </form>
