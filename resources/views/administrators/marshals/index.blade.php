    ...
    <x-containers.main>
        <div class="w-11/12 mx-auto my-3 border-b border-gray-300 pb-2">
            <div class="font-montserrat flex justify-between items-center">
                ...
                <a href="{{ route('administrators.marshals.history') }}" class="text-white bg-gray-800 hover:bg-gray-900 focus:outline-none focus:ring-4 focus:ring-gray-300 text-xs rounded-lg text-sm px-4 py-1.5 mr-2 mb-2 dark:bg-gray-800 dark:hover:bg-gray-700 dark:focus:ring-gray-700 dark:border-gray-700 flex items-center space-x-2">
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-4 h-4">
                                            ...
                                            <div class="flex items-center justify-center">
                                                <div class="ml-4">
                                                    ...
                                                    $marshal->id
                                                        ...
                                                        <form id="default-{{ $marshal->id }}"
                                                              action="{{ route('administrators.marshals.default', $marshal->id) }}"
                                            ...
                                            <div class="flex items-center justify-center">
                                                <div class="ml-4">
                                                    <div class="text-xs text-slate-600 flex space-x-3 items-center">
                                                        <div>
                                                            <a id="edit-button" href="{{ route('administrators.marshals.edit',
                                                    $marshal->id)
                                                    }}" class="text-cyan-700">
                                                        ...
                                                        ('administrators.marshals.destroy', $marshal->id) }}"
                                                              method="POST"
                                                              style="display: none">
                                                            @csrf
                                                            @method('DELETE')
