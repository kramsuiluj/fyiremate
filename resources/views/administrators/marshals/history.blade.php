                                                ...
                                                <div class="ml-4">
                                                    <div class="text-xs text-slate-600 flex space-x-3 items-center">
                                                        <section x-data="{ show: false }">
                                                            ...
                                                            <form id="restore-{{ $marshal->id }}"
                                                                  action="{{ route ('administrators.marshals.restore',
                                                              $marshal->id) }}"
                                                                  method="POST"
                                                            >
                                                                @csrf
                                                                                ...
                                                                                <div class="bg-white px-4 pt-5 pb-4 sm:p-6 sm:pb-4">
                                                                                    <div class="sm:flex sm:items-start">
                                                                                        ...
                                                                                        <div class="mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left">
                                                                                            ...
                                                                                            <div class="mt-2">
                                                                                                <p class="text-sm text-gray-500">Are you sure you want to restore this City Fire Marshal?</p>
                                                                                            </div>
                                                                                        </div>
                                                                                    </div>
                                                                                </div>
