<x-layout>
        ...
        <x-containers.content>
            <div>
                <h2 class="font-montserrat px-5 py-5 border-b text-center">
                    <span class="font-semibold text-blue-900">CREATE CITY FIRE MARSHAL</span>
                </h2>
            </div>
    ...
    <form action="{{ route('administrators.marshals.store') }}" method="POST" id="create-establishment">
        @csrf
    </form>
