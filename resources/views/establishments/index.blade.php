                                    ...
                                    <tbody class="bg-white divide-y divide-gray-200">
                                        @foreach($establishments as $establishment)
                                            <tr class="hover:bg-gray-100">
                                                    ...
                                                    <div class="flex items-center">
                                                        <div class="ml-4">
                                                            <div class="text-xs font-semibold text-slate-600">
                                                                <a href="{{ route('establishments.inspections.index', $establishment->id) }}" class="hover:underline">
                                                                    {{ $establishment->name }}
                                                                </a>
                                                            </div>
                                                        </div>
                                                ...
                                                <td x-data="{ show: false }" class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                                                    <div class="flex items-center">
                                                        <div class="ml-4">
                                                            <div class="text-xs font-medium text-slate-600">
                                                                <div class="flex space-x-3">
                                                                    <a href="{{ route('establishments.show', $establishment->id) }}" title="View Establishment Details" class="">
                                                                    ...
                                                                    <a href="{{ route('establishments.edit', $establishment->id) }}" title="Edit Establishment Details" class="">
                                                                    ...
                                                                    <a @click="show = !show" id="delete-button" href="javascript:void(0)" class="text-red-700"
