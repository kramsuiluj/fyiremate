<x-layout>
    ...
    <x-containers.main>
        ...
        <x-containers.content>
            <div>
                <h2 class="font-montserrat px-5 py-5 border-b text-center flex justify-center space-x-2 items-center">
                    <span>
                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round" class="feather feather-eye w-5 h-5 text-green-500"><path d="M1 12s4-8 11-8 11 8 11 8-4 8-11 8-11-8-11-8z"></path><circle cx="12" cy="12" r="3"></circle></svg>
                    </span>
            ...
            <div class="font-montserrat mt-5 px-5 pb-5 flex gap-5">
                <div class="w-1/2">
                    <div>
                        ...
                        <div class="relative mb-6">
                            ...
                            <input type="text" id="input-group-1" class="bg-gray-100 border border-gray-300 text-slate-600 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full pl-16 p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="No Input" value="{{ $establishment->date }}" disabled>
                        </div>
                    </div>
                    ...
                    <div>
                        ...
                        <div class="relative mb-6">
                            ...
                            <input type="text" id="input-group-1" class="bg-gray-100 border border-gray-300 text-slate-600 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full pl-16 p-2.5  dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="No Input" value="{{ $establishment->payments->last()->date_paid }}" disabled>
                        </div>
                    </div>
                    ...
                    <div>
                        ...
                        <div class="relative mb-6">
                            ...
                            <input type="text" id="input-group-1" class="bg-gray-100 border border-gray-300 text-slate-600 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full pl-16 p-2.5  dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="No Input" value="{{ $establishment->payments->last()->or_number }}" disabled>
                        </div>
                    </div>
                </div>
                ...
                <div class="w-1/2">
                    <div>
                        <label for="input-group-1" class="block mb-2 text-sm font-medium text-slate-600 dark:text-white">OPS #</label>
                        <div class="relative mb-6">
                            <div class="absolute inset-y-0 left-0 flex items-center pl-3 pointer-events-none">
                                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6">
                                    <path stroke-linecap="round" stroke-linejoin="round" d="M5.25 8.25h15m-16.5 7.5h15m-1.8-13.5l-3.9 19.5m-2.1-19.5l-3.9 19.5" />
                    ...
                    <div>
                        ...
                        <div class="relative mb-6">
                            ...
                            <input type="text" id="input-group-1" class="bg-gray-100 border border-gray-300 text-slate-600 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full pl-16 p-2.5  dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="No Input" value="{{ $establishment->date_released }}" disabled>
                        </div>
                    </div>

                    <div>
                        <label for="input-group-1" class="block mb-2 text-sm font-medium text-slate-600 dark:text-white">FSIC #</label>
                        <div class="relative mb-6">
                            <div class="absolute inset-y-0 left-0 flex items-center pl-3 pointer-events-none">
                                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6">
                                    <path stroke-linecap="round" stroke-linejoin="round" d="M5.25 8.25h15m-16.5 7.5h15m-1.8-13.5l-3.9 19.5m-2.1-19.5l-3.9 19.5" />
