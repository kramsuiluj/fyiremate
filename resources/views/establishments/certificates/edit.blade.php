        ...
        <x-containers.content>
            <section class="flex p-5 space-x-4 font-montserrat text-slate-700">
                <div class="w-1/2 space-y-3 flex flex-col">
                    ...
                    <input type="text" class="border border-gray-300 rounded-md bg-gray-200 text-sm" value="{{ $certificate->chief }}" disabled>
                ...
                <div class="w-1/2 space-y-3 flex flex-col">
                    ...
                    <input type="text" class="border border-gray-300 rounded-md bg-gray-200 text-sm" value="{{ $certificate->marshal }}" disabled>
...
<form style="display: none" action="{{ route('establishments.certificates.store', $establishment->id) }}" method="POST" id="create-io">
    ...
    <input type="hidden" name="chief" value="{{ $certificate->chief }}">
    <input type="hidden" name="marshal" value="{{ $certificate->marshal }}">
</form>
